...
// 回顾一下修改DOM的CSS、文本、设置HTML有多么麻烦，而且有的浏览器只有innerHTML，有的浏览器支持innerText，
...
// 如何设置文本或HTML？jQuery的API设计非常巧妙：无参数调用text()是获取文本，
// 传入参数就变成设置文本，HTML也是类似操作
...
var div = $('#test-div');
div.hasClass('highlight'); // flase,class是否包含highlight
...
var input = $('#test-input'),
    ...
    input.val(); // 'test'
    input.val('abc@example.com'); // 文本框的内容已经变为abc@example.com
