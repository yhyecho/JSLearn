...
$('div.testing li.lang-javascript'); // [<li class="lang-javascript"></li>]
...
// 就把选择范围限定在name属性为upload的表单里。
// 如果页面有很多表单，其他表单的<input>不会被选择。
...
// 就是<child>节点必须是<parent>节点的直属子节点。还是以上面的例子：
