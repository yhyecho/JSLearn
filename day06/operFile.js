...
// 注意：当一个表单包含<input type= "file">时，表单的enctype必须指定
// 为multipart/form-data, method必须指定为post，
// 浏览器才能正确编码并指定以multipart/form-data格式发送表单的数据。
...
// 上面的代码演示了如何通过HTML5的File API读取文件内容。以DataURL的形式读取到的文件是一个字符串，类似于data:image/jpeg;base64,/9j/4AAQSk...(base64编码)...，常用于设置图像。
